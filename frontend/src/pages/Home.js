  ...
  return (
    <div className="home-container">
      <div className="hero-section">
        ...
        <p className="hero-subtitle">Purchase tickets and get your money back, guaranteed. Win from the interest pool!</p>
      ...
      <div className="lottery-stats">
        <div className="stat-card">
          ...
          <div className={`status-badge ${lotteryData.drawCompleted ? 'completed' : 'active'}`}>
        ...
        <div className="stat-card">
          <h3>Interest Pool</h3>
          <div className="stat-value highlight">{parseFloat(lotteryData.interestPool).toFixed(2)} PYUSD</div>
        </div>
      </div>
      ...
      <div className="user-dashboard">
        ...
        <div className="dashboard-stats">
          ...
          {lotteryData.userTickets > 0 && !lotteryData.hasClaimed && lotteryData.drawCompleted && (
            <div className="dashboard-card action">
              <h3>Claim Status</h3>
              <button className="claim-button" onClick={() => setPage('claim')}>
                Claim Available
              </button>
            </div>
          )}
          ...
          {lotteryData.userTickets < 10 && !lotteryData.drawCompleted && (
            <div className="dashboard-card action">
              ...
              <button className="buy-more-button" onClick={() => setPage('buy')}>
                Buy More Tickets
              </button>
            </div>
          )}
